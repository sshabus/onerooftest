...
<nav class="navbar navbar-default navbar-fixed-top">
	  	<div class="clearfix">
	    	<a href = "/Venues" target = "_self"> 
	 	<img class="logo" src="/resources/img/Oneroof_logo_text.png" alt="Logo"/>
	 </a>
...
<div>
	 <div class="containerblock">
			<div class="container">
	      	...
	      	<div class="text">
	      		<h2>VENUE</h2>
	        		<p class="serviceinfo">Find your perfect location for a most memorable event, So look no further than finding your perfect venue in our directory of thousands of venues across India.</p>
	      	</div>
	    </div>
	</div> 
	...
	<div class="containerblock"> 
	    <div class="container">
	      <div class="text">
	      	<h2>CUISINE</h2>
	        <p class="serviceinfo">Any occasion is incomplete without the food and our team of talented chefs have extensive and rich experience, choosing from our list of finest caterers.</p>
	      </div>
	      <div class="image">
    ...
    <div class="container" >
      <div class="image">
        <img src="/resources/img/No_events.png">
      </div>
      <div class="text">
      	<h2>EVENTS</h2>
        <p class="serviceinfo">Find your perfect location for a most memorable event, So look no further than finding your perfect venue in our directory of thousands of venues across India.</p>
