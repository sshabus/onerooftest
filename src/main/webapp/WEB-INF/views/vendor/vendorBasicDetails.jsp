...
<form class="new-added-form" id="add_vendor_details_form" name="add_vendor_details_form" >
 	 	<div class="row">	
 	 		 <div class="col-xl-3 col-lg-6 col-12 form-group">
                ...
                <select class="select2" name="vendorType" id="vendorType" data-validation="required"  field-name="Vendor Type" readonly="readonly">
			    ...
			    url: appUrl+"/getVendorDetails?${_csrf.parameterName}=${_csrf.token}&vendorUUID="+vendorUUID,
			     success :function(response) {
			    	...
			    	$("#vendorBasicDetailsLoaderDiv").removeAttr("style");
			    	 $("select[name=vendorType]").val(response.object.vendorType); 
			    	 document.getElementById('select2-vendorType-container').innerHTML = response.object.vendorType;
