                        ...
                        <div class="heading-layout1">
                    	 ...
                    	 <div class="row">	
						   <div class="col-12 ui-btn-wrap">
						               ...
						               <c:if test="${empty guestUUID}">
						               <li><button type="button" class="btn-fill-lg font-normal text-light btn-gradient-yellow" onclick="javascript:window.location.href = '${Wayuparty_appUrl}/guest?vendorUUID=${vendorUUID}&serviceUUID=${serviceUUID}'"><i class="fas fa-undo mg-l-10"></i>&nbsp;Reset</button></li>
						               </c:if>
						               
						               <c:if test="${!empty guestUUID}">
						               <li><button type="button" class="btn-fill-lg font-normal text-light btn-gradient-yellow" onclick="javascript:window.location.href = '${Wayuparty_appUrl}/guest?vendorUUID=${vendorUUID}&serviceUUID=${serviceUUID}&guestUUID=${guestUUID}'"><i class="fas fa-undo mg-l-10"></i>&nbsp;Reset</button></li>
						               </c:if>
