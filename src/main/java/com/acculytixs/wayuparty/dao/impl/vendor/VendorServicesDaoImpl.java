...
public class VendorServicesDaoImpl implements VendorServicesDao{
	...
	public VendorServicesDTO getVendorServiceDetails(String serviceUUID) throws Exception {
		...
		query = "SELECT " 
				...
				+" IFNULL(vendorService.first_half_actual_price,0) AS firstHalfActualPrice, "
				+" IFNULL(vendorService.first_half_offer_price,0) AS firstHalfOfferPrice, "
				+" IFNULL(vendorService.second_half_actual_price,0) AS secondHalfActualPrice, "
				+" IFNULL(vendorService.second_half_offer_price,0) AS secondHalfOfferPrice, "
